...
>
  <BitsCheckbox.Root
    ...
    class={cn(
      ...
      "border-base-400 bg-base-100 inline-flex shrink-0 cursor-pointer items-center justify-center rounded-sm border transition-[background-color,border-color] duration-200",
      // Focus states
